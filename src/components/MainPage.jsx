...
import { ArrowRight, Calculator, Shield, Zap, ChevronRight } from 'lucide-react';
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div key={index} className="group relative">
                <div className="absolute inset-0 bg-gradient-to-r from-blue-600/10 to-purple-600/10 rounded-2xl transform transition-transform group-hover:scale-105"></div>
